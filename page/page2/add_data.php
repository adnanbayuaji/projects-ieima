<?php
    ...
    // echo $dateS;
    $SQL = "INSERT INTO data (data_suhu,data_kelembaban,data_intensitas,data_CO,data_kebisingan,data_waktu, sensor) VALUES ('".$suhu."','".$kelembaban."','".$intensitas."','".$co."','".$kebisingan."','$dateS', 2)";     
    // echo $SQL;
