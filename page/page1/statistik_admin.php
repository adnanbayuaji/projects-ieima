...
<body class="fix-header fix-sidebar card-no-border" onload="<?php echo $onload ?>">
    <!-- ============================================================== -->
                                  ...
                                  <!-- <li class="nav-item"> <a class="nav-link nav-toggler hidden-md-up text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="mdi mdi-menu"></i></a> </li> -->
                                    ...
                                    <?php
                                            // $querynotif = "SELECT dd.detail_keterangan as ket, d.data_waktu as waktu FROM detail_data dd JOIN data d ON dd.detail_iddata = d.data_id WHERE dd.detail_status = 1 AND d.data_waktu LIKE '$waktuUp%'";
                                              ...
                                              $time = date("Y-m-d H");  
                                              $a=0;
                                              $querynotif = "SELECT dd.detail_keterangan as ket, d.data_waktu as waktu FROM detail_data dd JOIN data d ON dd.detail_iddata = d.data_id WHERE dd.detail_status = 1 AND d.data_waktu LIKE '".$time."%' AND d.sensor = 1";
                                        ...
                                        <ul class="menu">
                                          <?php
                                            // $querynotif = "SELECT dd.detail_keterangan as ket, d.data_waktu as waktu FROM detail_data dd JOIN data d ON dd.detail_iddata = d.data_id WHERE dd.detail_status = 1 AND d.data_waktu LIKE '$waktuUp%'";
                                              ...
                                              date_default_timezone_set("Asia/Jakarta");
                                              $time = date("Y-m-d H");  
                                              $querynotif = "SELECT dd.detail_keterangan as ket, d.data_waktu as waktu, CASE WHEN d.sensor = 1 THEN 'R213' WHEN d.sensor = 2 THEN 'R407' WHEN d.sensor = 3 THEN 'R413' END as sensor FROM detail_data dd JOIN data d ON dd.detail_iddata = d.data_id WHERE dd.detail_status = 1 AND d.data_waktu LIKE '".$time."%' AND d.sensor = 1";
                        ...
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form method="post" action="statistik_admin.php">
